...
enum ENUM_MSG_TYPE
{
	...
	ENUM_MSG_TYPE_LS_FILE_REQUEST,      //显示文件
	ENUM_MSG_TYPE_DOWN_REQUEST,      //显示文件
	ENUM_MSG_TYPE_SEND_REQUEST,      //显示文件
	ENUM_MSG_TYPE_REMV_REQUEST,      //显示文件
	ENUM_MSG_TYPE_RENAME_REQUEST,      //显示文件
